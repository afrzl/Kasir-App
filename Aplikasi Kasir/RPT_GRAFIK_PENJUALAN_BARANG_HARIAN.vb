...
Public Class RPT_GRAFIK_PENJUALAN_BARANG_HARIAN
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_GRAFIK_PENJUALAN_BARANG_HARIAN.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Kasir.RPT_GRAFIK_PENJUALAN_BARANG_HARIAN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_GRAFIK_PENJUALAN_BARANG_HARIAN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_GRAFIK_PENJUALAN_BARANG_HARIAN = New RPT_GRAFIK_PENJUALAN_BARANG_HARIAN()
        rpt.Site = Me.Site
        Return rpt
    End Function
