...
Public Class RPT_EMPTY_DATA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Kasir.RPT_EMPTY_DATA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_EMPTY_DATA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_EMPTY_DATA = New RPT_EMPTY_DATA()
        rpt.Site = Me.Site
        Return rpt
    End Function
