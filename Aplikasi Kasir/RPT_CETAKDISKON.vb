...
Public Class RPT_CETAKDISKON
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Kasir.RPT_CETAKDISKON.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_CETAKDISKON
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CETAKDISKON = New RPT_CETAKDISKON()
        rpt.Site = Me.Site
        Return rpt
    End Function
