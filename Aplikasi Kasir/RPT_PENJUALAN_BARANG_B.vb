...
Public Class RPT_PENJUALAN_BARANG_B
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_PENJUALAN_BARANG_B.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Kasir.RPT_PENJUALAN_BARANG_B.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_PENJUALAN_BARANG_B
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_PENJUALAN_BARANG_B = New RPT_PENJUALAN_BARANG_B()
        rpt.Site = Me.Site
        Return rpt
    End Function
