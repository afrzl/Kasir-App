...
Public Class RPT_PENJUALAN_HARIAN
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_PENJUALAN_HARIAN.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Kasir.RPT_PENJUALAN_HARIAN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_PENJUALAN_HARIAN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_PENJUALAN_HARIAN = New RPT_PENJUALAN_HARIAN()
        rpt.Site = Me.Site
        Return rpt
    End Function
