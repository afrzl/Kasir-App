...
Public Class RPT_CETAKHARGA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Kasir.RPT_CETAKHARGA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_CETAKHARGA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CETAKHARGA = New RPT_CETAKHARGA()
        rpt.Site = Me.Site
        Return rpt
    End Function
