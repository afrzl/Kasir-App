...
Public Class RPT_CETAKLABEL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Kasir.RPT_CETAKLABEL.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Opsi() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_CETAKLABEL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CETAKLABEL = New RPT_CETAKLABEL()
        rpt.Site = Me.Site
        Return rpt
    End Function
